...
### 🚀 New in v1.3.2
- Default install now creates `~/.config/paste-gram/chat_ids.json` with placeholder aliases only.
- Override the destination chat on demand with `--id`/`-i`, supporting aliases via a JSON map.
